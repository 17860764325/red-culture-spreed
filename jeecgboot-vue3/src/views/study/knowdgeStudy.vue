<template>
  <div style="padding-left: 15%;padding-right: 15%;">
    ...
    <a-row v-for="item in objectInfoList" style="margin-top: 20px;border: black 2px solid;">
      <img style="width: 200px;height: 300px;padding: 10px" :src="item.objectImg"/>
      <a-card  style="height: 300px;width: 79%">
        ...
        <a-row style="">
<!--          打开弹窗进行学习-->
          <a-button type="primary" style="" @click="handleClick('1')">课程学习</a-button>
<!--          打开抽栏进行选择资源下载-->
          <a-button type="primary" style="margin-left: 30px" @click="handleClick('2')">资料下载</a-button>
<!--          点击弹窗，进入试卷选择页面，点击进行考试-->
          <a-button type="primary" style="margin-left: 30px" @click="handleClick('3')">课程考试</a-button>
<!--          点击展示抽栏论坛-->
          <a-button type="primary" style="margin-left: 30px" @click="handleClick('4')">课程讨论</a-button>
        </a-row>
      </a-card>
    </a-row>
  </div>
...
function handleClick(type){
  switch (type){
    case '1':
      openObjectStudyModal(true);
      break;
    case '2':
      openDrawer1(true)
      break;
    case '3':
      openObjectTestModal(true)
      break;
    case '4':
      openDrawer2(true)
      break;
