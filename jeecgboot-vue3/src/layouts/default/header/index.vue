<template>
  <Header :class="getHeaderClass">
    ...
    <div :class="`${prefixCls}-left`">
      ...
      <!-- 欢迎语 -->
      <span v-if="getShowContent && getShowBreadTitle && !getIsMobile" :class="[prefixCls, `${prefixCls}--${getHeaderTheme}`,'headerIntroductionClass']"> {{t('layout.header.welcomeIn')}} 红色文化党建宣传平台 </span>
    </div>
    <!-- left end -->
